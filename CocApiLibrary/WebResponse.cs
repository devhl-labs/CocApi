...
//this will probably make its way back in after a refactor
...
//        public WebResponse(int timeToWaitForWebRequests, VerbosityType verbosityType, IEnumerable<string> tokens, int tokenTimeOutInMilliseconds)
//        {
...
//        internal async Task<StoredItem<T>> GetWebResponse<T>(CocApi cocApi, string encodedUrl) where T : new()
//        {
...
//                if (result != null)
//                {
//                    StoredItem<T> cachedItem = new StoredItem<T>(result, stopwatch, encodedUrl);
