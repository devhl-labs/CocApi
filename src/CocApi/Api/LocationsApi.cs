...
namespace CocApi.Api
{
    ...
    public partial class LocationsApi
    {
        ...
        public LocationsApi(CocApi.Client.ISynchronousClient client,CocApi.Client.IAsynchronousClient asyncClient, CocApi.Client.IReadableConfiguration configuration)
        {
