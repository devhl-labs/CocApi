...
namespace CocApi.Api
{
    ...
    {
        private readonly ILogger<LeaguesApi> _logger;
        ...
        /// </summary>
        /// <returns></returns>
        public LeaguesApi(ILogger<LeaguesApi> logger, System.Net.Http.HttpClient httpClient, TokenProvider tokenProvider)
        {
            _logger = logger;
