...
namespace CocApi.Model
{
    ...
    /// ClanRankingList
    /// </summary>
    [DataContract(Name = "ClanRankingList")]
    public partial class ClanRankingList : IEquatable<ClanRankingList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClanRankingList" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        public ClanRankingList(List<ClanRanking> items)
        {
            Items = items;
        }
        ...
        public List<ClanRanking> Items { get; private set; }
        ...
        {
            return Equals(input as ClanRankingList);
        }
