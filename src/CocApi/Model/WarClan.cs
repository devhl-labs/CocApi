...
namespace CocApi.Model
{
    ...
    public partial class WarClan : IEquatable<WarClan>, IValidatableObject
    {
        ...
        public WarClan(float destructionPercentage, string tag, string name, ClanBadgeUrls badgeUrls, int clanLevel, int attacks, int stars, int expEarned, List<ClanWarMember> members)
        {
        ...
        {
            return Equals(input as WarClan);
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.ExpEarned.GetHashCode();
