...
namespace CocApi.Model
{
    ...
    /// PlayerRanking
    /// </summary>
    [DataContract(Name = "PlayerRanking")]
    public partial class PlayerRanking : IEquatable<PlayerRanking>, IValidatableObject
    {
        ...
        public PlayerRanking(PlayerRankingClan clan, League league, int attackWins, int defenseWins, string tag, string name, int expLevel, int rank, int previousRank, int trophies)
        {
            Clan = clan;
            League = league;
        ...
        {
            return Equals(input as PlayerRanking);
        }
