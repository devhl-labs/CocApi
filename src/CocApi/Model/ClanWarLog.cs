...
/// <summary>
    ...
    /// </summary>
    [DataContract]
    public partial class ClanWarLog :  IEquatable<ClanWarLog>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClanWarLog" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        public ClanWarLog(List<ClanWarLogEntry> items = default(List<ClanWarLogEntry>))
        {
            this.Items = items;
        }
        ...
        public List<ClanWarLogEntry> Items { get; private set; } //{#isReadOnly}private {/isReadOnly}set;
