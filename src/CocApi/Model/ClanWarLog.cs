...
namespace CocApi.Model
{
    ...
    public partial class ClanWarLog : IEquatable<ClanWarLog>, IValidatableObject
    {
        ...
        public ClanWarLog(List<ClanWarLogEntry> items)
        {
            Items = items;
        }
        ...
        public List<ClanWarLogEntry> Items { get; private set; }
        ...
        {
            return Equals(input as ClanWarLog);
        }
