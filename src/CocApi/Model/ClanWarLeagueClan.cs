...
namespace CocApi.Model
{
    ...
    /// ClanWarLeagueClan
    /// </summary>
    [DataContract(Name = "ClanWarLeagueClan")]
    public partial class ClanWarLeagueClan : IEquatable<ClanWarLeagueClan>, IValidatableObject
    {
        ...
        public ClanWarLeagueClan(string tag, int clanLevel, string name, List<ClanWarLeagueClanMember> members, ClanBadgeUrls badgeUrls)
        {
            Tag = tag;
            ClanLevel = clanLevel;
            Name = name;
        ...
        {
            return Equals(input as ClanWarLeagueClan);
        }
