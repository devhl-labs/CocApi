...
namespace CocApi.Model
{
    ...
    /// PlayerRankingList
    /// </summary>
    [DataContract(Name = "PlayerRankingList")]
    public partial class PlayerRankingList : IEquatable<PlayerRankingList>, IValidatableObject
    {
        ...
        public PlayerRankingList(List<PlayerRanking> items)
        {
            Items = items;
        }
        ...
        public List<PlayerRanking> Items { get; private set; }
        ...
        {
            return Equals(input as PlayerRankingList);
        }
