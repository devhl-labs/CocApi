...
namespace CocApi.Model
{
    ...
    /// ClanList
    /// </summary>
    [DataContract(Name = "ClanList")]
    public partial class ClanList : IEquatable<ClanList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClanList" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        public ClanList(List<Clan> items)
        {
            Items = items;
        }
        ...
        public List<Clan> Items { get; private set; }
        ...
        {
            return Equals(input as ClanList);
        }
