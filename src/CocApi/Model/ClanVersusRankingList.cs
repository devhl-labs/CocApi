...
namespace CocApi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ClanVersusRankingList")]
    public partial class ClanVersusRankingList : IEquatable<ClanVersusRankingList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClanVersusRankingList" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        public ClanVersusRankingList(List<ClanVersusRanking> items)
        {
            Items = items;
        }
        ...
        {
            return Equals(input as ClanVersusRankingList);
        }
