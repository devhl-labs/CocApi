...
namespace CocApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PlayerRankingClan :  IValidatableObject
    {
        /// <summary>
        ...
        public PlayerRankingClan(string tag = default(string), string name = default(string), ClanBadgeUrls badgeUrls = default(ClanBadgeUrls))
        {
            this.Tag = tag;
            this.Name = name;
