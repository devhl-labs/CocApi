...
/// <summary>
    ...
    public partial class ClanRanking :  IEquatable<ClanRanking>, IValidatableObject
    {
        ...
        public ClanRanking(int clanLevel = default(int), int clanPoints = default(int), Location location = default(Location), int members = default(int), string tag = default(string), string name = default(string), int rank = default(int), int previousRank = default(int), ClanBadgeUrls badgeUrls = default(ClanBadgeUrls))
        {
