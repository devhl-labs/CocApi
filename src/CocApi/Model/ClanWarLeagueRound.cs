...
namespace CocApi.Model
{
    ...
    /// ClanWarLeagueRound
    /// </summary>
    [DataContract(Name = "ClanWarLeagueRound")]
    public partial class ClanWarLeagueRound : IEquatable<ClanWarLeagueRound>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClanWarLeagueRound" /> class.
        /// </summary>
        /// <param name="warTags">warTags.</param>
        public ClanWarLeagueRound(List<string> warTags)
        {
            WarTags = warTags;
        }
        ...
        {
            return Equals(input as ClanWarLeagueRound);
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.WarTags != null)
                    hashCode = hashCode * 59 + this.WarTags.GetHashCode();
                return hashCode;
            }
        }
