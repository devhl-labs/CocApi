...
inputSpec: C:\Users\devhl\repos\Clash-of-Clans-Swagger\swagger-3.0-appended-properties.yml
outputDir: out
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IGetCapitalRaidSeasonsApiResponse apiResponse = await api.GetCapitalRaidSeasonsAsync("todo");
        ...
        public static IHostBuilder CreateHostBuilder(string[] args) => Host.CreateDefaultBuilder(args)
          .ConfigureCocApi((context, options) =>
          {
              ...
              options.AddCocApiHttpClients(client =>
              {
...
- SDK version: 3.0.0-rc20260719
- Build date: 2026-07-19T18:52:18.922606600-04:00[America/New_York]
