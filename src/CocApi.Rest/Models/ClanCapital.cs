...
namespace CocApi.Rest.Models
{
    ...
    /// <summary>
    /// A Json converter for type <see cref="ClanCapital" />
    /// </summary>
    public partial class ClanCapitalJsonConverter : JsonConverter<ClanCapital>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ClanCapitalJsonConverter" /> class.
        /// </summary>
        public ClanCapitalJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="ClanCapital" />
        /// </summary>
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "capitalHallLevel":
                            capitalHallLevel = new Option<int?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (int?)null : utf8JsonReader.GetInt32());
                            break;
                        case "districts":
        ...
        /// <summary>
        /// Serializes a <see cref="ClanCapital" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, ClanCapital clanCapital, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, clanCapital, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ClanCapital clanCapital, JsonSerializerOptions jsonSerializerOptions)
        {
