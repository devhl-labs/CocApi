...
namespace CocApi.Rest.Models
{
    ...
    /// </summary>
    public partial class ClanCapitalRaidSeasonDistrictJsonConverter : JsonConverter<ClanCapitalRaidSeasonDistrict>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ClanCapitalRaidSeasonDistrictJsonConverter" /> class.
        /// </summary>
        public ClanCapitalRaidSeasonDistrictJsonConverter()
        {
            OnCreated();
        }
