...
namespace CocApi.Rest.Models
{
    ...
    /// </summary>
    public partial class BadgeUrlsJsonConverter : JsonConverter<BadgeUrls>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="BadgeUrlsJsonConverter" /> class.
        /// </summary>
        public BadgeUrlsJsonConverter()
        {
            OnCreated();
        }
