...
namespace CocApi.Rest.Models
{
    ...
    /// </summary>
    public partial class PlayerRankingJsonConverter : JsonConverter<PlayerRanking>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="PlayerRankingJsonConverter" /> class.
        /// </summary>
        public PlayerRankingJsonConverter()
        {
            OnCreated();
        }
