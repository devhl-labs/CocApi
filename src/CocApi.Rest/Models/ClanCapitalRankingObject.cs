...
namespace CocApi.Rest.Models
{
    ...
    /// </summary>
    public partial class ClanCapitalRankingObjectJsonConverter : JsonConverter<ClanCapitalRankingObject>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ClanCapitalRankingObjectJsonConverter" /> class.
        /// </summary>
        public ClanCapitalRankingObjectJsonConverter()
        {
            OnCreated();
        }
        ...
        public override ClanCapitalRankingObject Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<ClanCapitalRanking>?> items = default;
            ...
            if (!items.IsSet)
                throw new ArgumentException("Property is required for class ClanCapitalRankingObject.", nameof(items));

            if (items.IsSet && items.Value == null)
                throw new ArgumentNullException(nameof(items), "Property is not nullable for class ClanCapitalRankingObject.");

            return new ClanCapitalRankingObject(items.Value!);
        }
