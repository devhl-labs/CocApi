...
#pragma warning disable CS8073 // The result of the expression is always the same since a value of this type is never equal to 'null'
            ...
            if (items == null)
                throw new ArgumentNullException("items is a required property for ClanRankingList and cannot be null.");
...
#pragma warning restore CS8073 // The result of the expression is always the same since a value of this type is never equal to 'null'
    ...
    public class ClanRankingListJsonConverter : JsonConverter<ClanRankingList>
    {
        ...
        public override ClanRankingList Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
                ...
                if (reader.TokenType == JsonTokenType.PropertyName)
                {
                    ...
                    switch (propertyName)
                    {
                        case "items":
                            ...
                            items = JsonSerializer.Deserialize<List<ClanRanking>>(ref reader, options);
                            break;
                    }
                }
            }
        ...
        public override void Write(Utf8JsonWriter writer, ClanRankingList clanRankingList, JsonSerializerOptions options)
        {
            writer.WriteStartObject();

            writer.WritePropertyName("items");
            JsonSerializer.Serialize(writer, clanRankingList.Items, options);
