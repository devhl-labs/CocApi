...
namespace CocApi.Rest.Models
{
    ...
    /// </summary>
    public partial class WarClanLogEntryJsonConverter : JsonConverter<WarClanLogEntry>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="WarClanLogEntryJsonConverter" /> class.
        /// </summary>
        public WarClanLogEntryJsonConverter()
        {
            OnCreated();
        }
        ...
        public override void Write(Utf8JsonWriter writer, WarClanLogEntry warClanLogEntry, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, warClanLogEntry, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, WarClanLogEntry warClanLogEntry, JsonSerializerOptions jsonSerializerOptions)
        {
