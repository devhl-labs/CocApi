...
#pragma warning restore CS8073 // The result of the expression is always the same since a value of this type is never equal to 'null'
    ...
    public class WarClanLogEntryJsonConverter : JsonConverter<WarClanLogEntry>
    {
        ...
        public override WarClanLogEntry Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
        ...
        public override void Write(Utf8JsonWriter writer, WarClanLogEntry warClanLogEntry, JsonSerializerOptions options)
        {
            writer.WriteStartObject();

            writer.WriteNumber("attacks", (int)warClanLogEntry.Attacks);
