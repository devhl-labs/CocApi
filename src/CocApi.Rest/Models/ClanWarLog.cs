...
#pragma warning disable CS8073 // The result of the expression is always the same since a value of this type is never equal to 'null'
            ...
            if (items == null)
                throw new ArgumentNullException("items is a required property for ClanWarLog and cannot be null.");
...
#pragma warning restore CS8073 // The result of the expression is always the same since a value of this type is never equal to 'null'
    ...
    /// <summary>
    /// A Json converter for type ClanWarLog
    /// </summary>
    public class ClanWarLogJsonConverter : JsonConverter<ClanWarLog>
    {
        ...
        public override ClanWarLog Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            while (reader.Read())
            {
                ...
                if (reader.TokenType == JsonTokenType.PropertyName && currentDepth == reader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "items":
                            items = JsonSerializer.Deserialize<List<ClanWarLogEntry>>(ref reader, options);
                            break;
                        default:
                            break;
                    }
        ...
        public override void Write(Utf8JsonWriter writer, ClanWarLog clanWarLog, JsonSerializerOptions options)
        {
            writer.WriteStartObject();

            writer.WritePropertyName("items");
            JsonSerializer.Serialize(writer, clanWarLog.Items, options);
