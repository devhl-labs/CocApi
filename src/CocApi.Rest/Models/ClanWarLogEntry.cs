...
#pragma warning restore CS8073 // The result of the expression is always the same since a value of this type is never equal to 'null'
    ...
    public class ClanWarLogEntryJsonConverter : JsonConverter<ClanWarLogEntry>
    {
        ...
        public override ClanWarLogEntry Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
                ...
                if (reader.TokenType == JsonTokenType.PropertyName)
                {
                    ...
                    switch (propertyName)
                    {
                        ...
                        case "clan":
                            ...
                            clan = JsonSerializer.Deserialize<WarClanLogEntry>(ref reader, options);
                            break;
                        case "endTime":
                        ...
                        case "opponent":
                            ...
                            opponent = JsonSerializer.Deserialize<WarClanLogEntry>(ref reader, options);
                            break;
                        case "teamSize":
        ...
        public override void Write(Utf8JsonWriter writer, ClanWarLogEntry clanWarLogEntry, JsonSerializerOptions options)
        {
            writer.WriteStartObject();

            writer.WriteNumber("attacksPerMember", (int)clanWarLogEntry.AttacksPerMember);
            writer.WritePropertyName("clan");
            JsonSerializer.Serialize(writer, clanWarLogEntry.Clan, options);
            writer.WritePropertyName("endTime");
            JsonSerializer.Serialize(writer, clanWarLogEntry.EndTime, options);
            writer.WritePropertyName("opponent");
            JsonSerializer.Serialize(writer, clanWarLogEntry.Opponent, options);
            writer.WriteNumber("teamSize", (int)clanWarLogEntry.TeamSize);
