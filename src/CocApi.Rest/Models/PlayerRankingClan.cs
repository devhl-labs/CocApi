...
#pragma warning disable CS8073 // The result of the expression is always the same since a value of this type is never equal to 'null'
            ...
            if (tag == null)
                throw new ArgumentNullException("tag is a required property for PlayerRankingClan and cannot be null.");

            if (name == null)
                throw new ArgumentNullException("name is a required property for PlayerRankingClan and cannot be null.");

            if (badgeUrls == null)
                throw new ArgumentNullException("badgeUrls is a required property for PlayerRankingClan and cannot be null.");
...
#pragma warning restore CS8073 // The result of the expression is always the same since a value of this type is never equal to 'null'
    ...
    public class PlayerRankingClanJsonConverter : JsonConverter<PlayerRankingClan>
    {
        ...
        public override PlayerRankingClan Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
        ...
        public override void Write(Utf8JsonWriter writer, PlayerRankingClan playerRankingClan, JsonSerializerOptions options)
        {
            writer.WriteStartObject();

            writer.WritePropertyName("badgeUrls");
            JsonSerializer.Serialize(writer, playerRankingClan.BadgeUrls, options);
