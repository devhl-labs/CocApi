...
namespace CocApi.Rest.Models
{
    ...
    /// </summary>
    public partial class PlayerRankingClanJsonConverter : JsonConverter<PlayerRankingClan>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="PlayerRankingClanJsonConverter" /> class.
        /// </summary>
        public PlayerRankingClanJsonConverter()
        {
            OnCreated();
        }
