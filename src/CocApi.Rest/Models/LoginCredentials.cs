...
#pragma warning restore CS8073 // The result of the expression is always the same since a value of this type is never equal to 'null'
    ...
    public class LoginCredentialsJsonConverter : JsonConverter<LoginCredentials>
    {
        ...
        public override LoginCredentials Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
        ...
        public override void Write(Utf8JsonWriter writer, LoginCredentials loginCredentials, JsonSerializerOptions options)
        {
