...
#pragma warning restore CS8073 // The result of the expression is always the same since a value of this type is never equal to 'null'
    ...
    public class ClanWarLeagueGroupJsonConverter : JsonConverter<ClanWarLeagueGroup>
    {
        ...
        public override ClanWarLeagueGroup Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            while (reader.Read())
            {
                ...
                if (reader.TokenType == JsonTokenType.PropertyName)
                {
                    ...
                    {
                        case "clans":
                            Utf8JsonReader clansReader = reader;
                            clans = JsonSerializer.Deserialize<List<ClanWarLeagueClan>>(ref reader, options);
                            break;
                        case "rounds":
                            Utf8JsonReader roundsReader = reader;
                            rounds = JsonSerializer.Deserialize<List<ClanWarLeagueRound>>(ref reader, options);
                            break;
                        case "season":
                            Utf8JsonReader seasonReader = reader;
                            season = JsonSerializer.Deserialize<DateTime>(ref reader, options);
                            break;
                        case "state":
        ...
        public override void Write(Utf8JsonWriter writer, ClanWarLeagueGroup clanWarLeagueGroup, JsonSerializerOptions options)
        {
            writer.WriteStartObject();

            writer.WritePropertyName("clans");
            JsonSerializer.Serialize(writer, clanWarLeagueGroup.Clans, options);
            writer.WritePropertyName("rounds");
            JsonSerializer.Serialize(writer, clanWarLeagueGroup.Rounds, options);
            writer.WritePropertyName("season");
            JsonSerializer.Serialize(writer, clanWarLeagueGroup.Season, options);
