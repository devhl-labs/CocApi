...
#pragma warning restore CS8073 // The result of the expression is always the same since a value of this type is never equal to 'null'
    ...
    public class ClanVersusRankingListJsonConverter : JsonConverter<ClanVersusRankingList>
    {
        ...
        public override ClanVersusRankingList Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
                ...
                if (reader.TokenType == JsonTokenType.PropertyName)
                {
                    ...
                    switch (propertyName)
                    {
                        case "items":
                            ...
                            items = JsonSerializer.Deserialize<List<ClanVersusRanking>>(ref reader, options);
                            break;
                    }
                }
            }
        ...
        public override void Write(Utf8JsonWriter writer, ClanVersusRankingList clanVersusRankingList, JsonSerializerOptions options)
        {
            writer.WriteStartObject();

            writer.WritePropertyName("items");
            JsonSerializer.Serialize(writer, clanVersusRankingList.Items, options);
