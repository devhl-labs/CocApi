...
namespace CocApi.Rest.Models
{
    ...
    public class ClanVersusRankingJsonConverter : JsonConverter<ClanVersusRanking>
    {
        ...
        public override ClanVersusRanking Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
...
#pragma warning restore CS8073 // The result of the expression is always the same since a value of this type is never equal to 'null'
        ...
        public override void Write(Utf8JsonWriter writer, ClanVersusRanking clanVersusRanking, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            writer.WriteNumber("clanPoints", clanVersusRanking.ClanPoints);
            writer.WriteNumber("clanVersusPoints", clanVersusRanking.ClanVersusPoints);
