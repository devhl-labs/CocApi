...
#pragma warning restore CS8073 // The result of the expression is always the same since a value of this type is never equal to 'null'
    ...
    public class ClanListEntryJsonConverter : JsonConverter<ClanListEntry>
    {
        ...
        public override ClanListEntry Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
        ...
        public override void Write(Utf8JsonWriter writer, ClanListEntry clanListEntry, JsonSerializerOptions options)
        {
            writer.WriteStartObject();

            writer.WritePropertyName("badgeUrls");
            JsonSerializer.Serialize(writer, clanListEntry.BadgeUrls, options);
            writer.WriteNumber("clanLevel", (int)clanListEntry.ClanLevel);
            writer.WriteNumber("clanPoints", (int)clanListEntry.ClanPoints);
            writer.WriteNumber("clanVersusPoints", (int)clanListEntry.ClanVersusPoints);
            writer.WriteBoolean("isWarLogPublic", clanListEntry.IsWarLogPublic);
            writer.WritePropertyName("labels");
            JsonSerializer.Serialize(writer, clanListEntry.Labels, options);
            writer.WriteNumber("members", (int)clanListEntry.Members);
            writer.WriteString("name", clanListEntry.Name);
            writer.WriteNumber("requiredTrophies", (int)clanListEntry.RequiredTrophies);
            writer.WriteString("tag", clanListEntry.Tag);
            writer.WritePropertyName("warLeague");
            JsonSerializer.Serialize(writer, clanListEntry.WarLeague, options);
            writer.WriteNumber("warWinStreak", (int)clanListEntry.WarWinStreak);
            writer.WriteNumber("warWins", (int)clanListEntry.WarWins);
            writer.WritePropertyName("chatLanguage");
            JsonSerializer.Serialize(writer, clanListEntry.ChatLanguage, options);
            writer.WritePropertyName("location");
            JsonSerializer.Serialize(writer, clanListEntry.Location, options);
            ...
            if (clanListEntry.WarLosses != null)
                writer.WriteNumber("warLosses", (int)clanListEntry.WarLosses.Value);
            else
                writer.WriteNull("warLosses");
            if (clanListEntry.WarTies != null)
                writer.WriteNumber("warTies", (int)clanListEntry.WarTies.Value);
            else
