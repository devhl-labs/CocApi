...
#pragma warning restore CS8073 // The result of the expression is always the same since a value of this type is never equal to 'null'
    ...
    public class PlayerJsonConverter : JsonConverter<Player>
    {
        ...
        public override Player Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            while (reader.Read())
            {
                ...
                if (reader.TokenType == JsonTokenType.PropertyName)
                {
                    ...
                    {
                        case "achievements":
                            Utf8JsonReader achievementsReader = reader;
                            achievements = JsonSerializer.Deserialize<List<PlayerAchievementProgress>>(ref reader, options);
                            break;
                        case "attackWins":
                            attackWins = reader.GetInt32();
                            break;
                        case "bestTrophies":
                            bestTrophies = reader.GetInt32();
                            break;
                        case "bestVersusTrophies":
                            bestVersusTrophies = reader.GetInt32();
                            break;
                        ...
                        case "expLevel":
                            ...
                            break;
                        case "heroes":
                            Utf8JsonReader heroesReader = reader;
                            heroes = JsonSerializer.Deserialize<List<PlayerItemLevel>>(ref reader, options);
                            break;
                        case "labels":
                        ...
                        case "name":
                            ...
                            break;
                        case "spells":
                            Utf8JsonReader spellsReader = reader;
                            spells = JsonSerializer.Deserialize<List<PlayerItemLevel>>(ref reader, options);
                            break;
                        case "tag":
                        ...
                        case "townHallLevel":
                            ...
                            break;
                        case "troops":
                            Utf8JsonReader troopsReader = reader;
                            troops = JsonSerializer.Deserialize<List<PlayerItemLevel>>(ref reader, options);
                            break;
                        case "trophies":
                            trophies = reader.GetInt32();
                            break;
                        case "versusBattleWinCount":
                            versusBattleWinCount = reader.GetInt32();
                            break;
                        ...
                        case "versusTrophies":
                            ...
                            break;
                        case "warStars":
                            warStars = reader.GetInt32();
                            break;
                        case "clan":
                            Utf8JsonReader clanReader = reader;
                            clan = JsonSerializer.Deserialize<PlayerClan>(ref reader, options);
                            break;
                        case "league":
                        ...
                        case "legendStatistics":
                            Utf8JsonReader legendStatisticsReader = reader;
                            legendStatistics = JsonSerializer.Deserialize<PlayerLegendStatistics>(ref reader, options);
                            break;
                        case "role":
                        ...
                        case "townHallWeaponLevel":
                            if (reader.TokenType != JsonTokenType.Null)
                                townHallWeaponLevel = reader.GetInt32();
                            break;
                        case "warPreference":
        ...
        public override void Write(Utf8JsonWriter writer, Player player, JsonSerializerOptions options)
        {
            ...
            JsonSerializer.Serialize(writer, player.Achievements, options);
            writer.WriteNumber("attackWins", (int)player.AttackWins);
            ...
            writer.WriteNumber("expLevel", (int)player.ExpLevel);
            writer.WritePropertyName("heroes");
            JsonSerializer.Serialize(writer, player.Heroes, options);
            writer.WritePropertyName("labels");
            JsonSerializer.Serialize(writer, player.Labels, options);
            writer.WriteString("name", player.Name);
            writer.WritePropertyName("spells");
            JsonSerializer.Serialize(writer, player.Spells, options);
            writer.WriteString("tag", player.Tag);
            writer.WriteNumber("townHallLevel", (int)player.TownHallLevel);
            writer.WritePropertyName("troops");
            JsonSerializer.Serialize(writer, player.Troops, options);
            writer.WriteNumber("trophies", (int)player.Trophies);
            writer.WriteNumber("versusBattleWinCount", (int)player.VersusBattleWinCount);
            writer.WriteNumber("versusBattleWins", (int)player.VersusBattleWins);
            writer.WriteNumber("versusTrophies", (int)player.VersusTrophies);
            writer.WriteNumber("warStars", (int)player.WarStars);
            writer.WritePropertyName("clan");
            JsonSerializer.Serialize(writer, player.Clan, options);
            writer.WritePropertyName("league");
            JsonSerializer.Serialize(writer, player.League, options);
            writer.WritePropertyName("legendStatistics");
            JsonSerializer.Serialize(writer, player.LegendStatistics, options);
            if (player.Role == null)
            ...
            if (player.TownHallWeaponLevel != null)
                writer.WriteNumber("townHallWeaponLevel", (int)player.TownHallWeaponLevel.Value);
            else
