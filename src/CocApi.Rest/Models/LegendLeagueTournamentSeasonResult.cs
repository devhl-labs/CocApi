...
#pragma warning restore CS8073 // The result of the expression is always the same since a value of this type is never equal to 'null'
    ...
    public class LegendLeagueTournamentSeasonResultJsonConverter : JsonConverter<LegendLeagueTournamentSeasonResult>
    {
        ...
        public override LegendLeagueTournamentSeasonResult Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            while (reader.Read())
            {
                ...
                if (reader.TokenType == JsonTokenType.PropertyName)
                {
                    ...
                    {
                        case "id":
                            Utf8JsonReader idReader = reader;
                            id = JsonSerializer.Deserialize<DateTime>(ref reader, options);
                            break;
                        case "rank":
        ...
        public override void Write(Utf8JsonWriter writer, LegendLeagueTournamentSeasonResult legendLeagueTournamentSeasonResult, JsonSerializerOptions options)
        {
            writer.WriteStartObject();

            writer.WritePropertyName("id");
            JsonSerializer.Serialize(writer, legendLeagueTournamentSeasonResult.Id, options);
            writer.WriteNumber("rank", (int)legendLeagueTournamentSeasonResult.Rank);
            writer.WriteNumber("trophies", (int)legendLeagueTournamentSeasonResult.Trophies);
