...
namespace CocApi.Rest.Models
{
    ...
    /// </summary>
    public partial class ClanListJsonConverter : JsonConverter<ClanList>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ClanListJsonConverter" /> class.
        /// </summary>
        public ClanListJsonConverter()
        {
            OnCreated();
        }
        ...
        public override ClanList Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<ClanListEntry>?> items = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "items":
                            items = new Option<List<ClanListEntry>?>(JsonSerializer.Deserialize<List<ClanListEntry>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (!items.IsSet)
                throw new ArgumentException("Property is required for class ClanList.", nameof(items));

            if (items.IsSet && items.Value == null)
                throw new ArgumentNullException(nameof(items), "Property is not nullable for class ClanList.");

            return new ClanList(items.Value!);
        }
        ...
        public override void Write(Utf8JsonWriter writer, ClanList clanList, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, clanList, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ClanList clanList, JsonSerializerOptions jsonSerializerOptions)
        {
            if (clanList.Items == null)
                throw new ArgumentNullException(nameof(clanList.Items), "Property is required for class ClanList.");
