...
#pragma warning restore CS8073 // The result of the expression is always the same since a value of this type is never equal to 'null'
    ...
    public class CreateTokenRequestJsonConverter : JsonConverter<CreateTokenRequest>
    {
        ...
        public override CreateTokenRequest Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
        ...
        public override void Write(Utf8JsonWriter writer, CreateTokenRequest createTokenRequest, JsonSerializerOptions options)
        {
            writer.WriteStartObject();

            writer.WritePropertyName("cidrRanges");
            JsonSerializer.Serialize(writer, createTokenRequest.CidrRanges, options);
