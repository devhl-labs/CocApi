...
#pragma warning disable CS8073 // The result of the expression is always the same since a value of this type is never equal to 'null'
            ...
            if (tag == null)
                throw new ArgumentNullException("tag is a required property for ClanWarLeagueClan and cannot be null.");

            if (clanLevel == null)
                throw new ArgumentNullException("clanLevel is a required property for ClanWarLeagueClan and cannot be null.");

            if (name == null)
                throw new ArgumentNullException("name is a required property for ClanWarLeagueClan and cannot be null.");

            if (members == null)
                throw new ArgumentNullException("members is a required property for ClanWarLeagueClan and cannot be null.");

            if (badgeUrls == null)
                throw new ArgumentNullException("badgeUrls is a required property for ClanWarLeagueClan and cannot be null.");
...
#pragma warning restore CS8073 // The result of the expression is always the same since a value of this type is never equal to 'null'
    ...
    /// <summary>
    /// A Json converter for type ClanWarLeagueClan
    /// </summary>
    public class ClanWarLeagueClanJsonConverter : JsonConverter<ClanWarLeagueClan>
    {
        ...
        public override ClanWarLeagueClan Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
                ...
                if (reader.TokenType == JsonTokenType.PropertyName)
                {
                    ...
                    switch (propertyName)
                    {
                        ...
                        case "members":
                            ...
                            members = JsonSerializer.Deserialize<List<ClanWarLeagueClanMember>>(ref reader, options);
                            break;
                        case "name":
            ...
            return new ClanWarLeagueClan(badgeUrls, clanLevel, members, name, tag);
        }
        ...
        public override void Write(Utf8JsonWriter writer, ClanWarLeagueClan clanWarLeagueClan, JsonSerializerOptions options)
        {
            writer.WriteStartObject();

            writer.WritePropertyName("badgeUrls");
            JsonSerializer.Serialize(writer, clanWarLeagueClan.BadgeUrls, options);
            writer.WriteNumber("clanLevel", (int)clanWarLeagueClan.ClanLevel);
            writer.WritePropertyName("members");
            JsonSerializer.Serialize(writer, clanWarLeagueClan.Members, options);
