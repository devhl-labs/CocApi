...
namespace CocApi.Rest.Models
{
    ...
    /// </summary>
    public partial class ClanWarLeagueRoundJsonConverter : JsonConverter<ClanWarLeagueRound>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ClanWarLeagueRoundJsonConverter" /> class.
        /// </summary>
        public ClanWarLeagueRoundJsonConverter()
        {
            OnCreated();
        }
        ...
        /// <summary>
        /// Serializes the properties of <see cref="ClanWarLeagueRound" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="clanWarLeagueRound"></param>
        /// <param name="jsonSerializerOptions"></param>
