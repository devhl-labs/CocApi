...
namespace CocApi.Rest.Models
{
    ...
    /// </summary>
    public partial class LeagueListJsonConverter : JsonConverter<LeagueList>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="LeagueListJsonConverter" /> class.
        /// </summary>
        public LeagueListJsonConverter()
        {
            OnCreated();
        }
        ...
        public override void Write(Utf8JsonWriter writer, LeagueList leagueList, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, leagueList, jsonSerializerOptions);
        ...
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, LeagueList leagueList, JsonSerializerOptions jsonSerializerOptions)
        {
