...
//        public Test(CocApiClient_old cocApi) => _cocApi = cocApi;
...
//        //public void OnAddedToWarLog(WarLogEntry warLogEntry, CurrentWar storedWar) => _cocApi.Wars.OnAddedToWarLog(warLogEntry, storedWar);
