...
namespace CocApi.Test
{
    class Program
    {
        ...
        //public static ClansCacheBase ClansCache { get; set; }
        ...
        public static async Task Main(string[] args)
        {
            ...
            //PlayersApi playersApi = new PlayersApi(tokenProvider);

            //ClansApi clansApi = new ClansApi(tokenProvider);

            //PlayersCache = new PlayersCache(cacheConfiguration, playersApi);

            //ClansCache = new ClansCacheBase(cacheConfiguration, clansApi, PlayersCache);
